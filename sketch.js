...
function preload(){
  ...
  blow1=loadSound("blow1.wav");
  blow2=loadSound("blow2.wav");
  blow3=loadSound("blow3.ogg");
  blow4=loadSound("blow4.mp3");
}
function setup(){
...
if (gameState==1)
{
  gameOver=createSprite(590,250,10,10);
